#pragma checksum "D:\Delivery\src\Inventory.App\Views\Customers\CustomersView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "6480C633DC01A2D7F77E7C58228DFD9A"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Inventory.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ICustomersView_Bindings
        {
            ...
            private global::Inventory.Views.CustomerAddressList obj10;
            private global::Inventory.Views.CommunicationList obj11;
            private global::Inventory.Views.CustomersDetails obj12;
            private global::Inventory.Controls.Section obj13;
            private global::Inventory.Views.CustomersList obj14;
            ...
            private static bool isobj11ViewModelDisabled = false;
            private static bool isobj12ViewModelDisabled = false;
            private static bool isobj13HeaderDisabled = false;
            private static bool isobj13IsButtonVisibleDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 58 && columnNumber == 54)
                {
                    isobj11ViewModelDisabled = true;
                }
                ...
                {
                    isobj13IsButtonVisibleDisabled = true;
                }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 6: // Views\Customers\CustomersView.xaml line 47
                        ...
                        break;
                    case 7: // Views\Customers\CustomersView.xaml line 70
                        this.obj7 = (global::Inventory.Controls.Section)target;
                        break;
                    case 9: // Views\Customers\CustomersView.xaml line 64
                        this.obj9 = (global::Inventory.Views.CustomersOrders)target;
                        break;
                    case 10: // Views\Customers\CustomersView.xaml line 61
                        this.obj10 = (global::Inventory.Views.CustomerAddressList)target;
                        break;
                    case 11: // Views\Customers\CustomersView.xaml line 58
                        this.obj11 = (global::Inventory.Views.CommunicationList)target;
                        break;
                    case 12: // Views\Customers\CustomersView.xaml line 55
                        this.obj12 = (global::Inventory.Views.CustomersDetails)target;
                        break;
                    case 13: // Views\Customers\CustomersView.xaml line 33
                        this.obj13 = (global::Inventory.Controls.Section)target;
                        break;
                    case 14: // Views\Customers\CustomersView.xaml line 38
                        this.obj14 = (global::Inventory.Views.CustomersList)target;
                        break;
                    default:
                        break;
                }
            ...
            private void Invoke_M_GetRowSpan_4125562139(int phase)
            {
            ...
            private void Update_(global::Inventory.Views.CustomersView obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_M_GetRowSpan_4125562139(phase);
                    }
                }
            ...
            private void Update_ViewModel_CustomerList(global::Inventory.ViewModels.CustomerListViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Inventory_Views_CustomersList_ViewModel(this.obj14, obj, null);
                    }
                }
            }
            private void Update_ViewModel_CustomerList_Title(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Inventory_Controls_Section_Header(this.obj13, obj, null);
                    }
                }
            }
            ...
            private void Update_M_GetRowSpan_4125562139(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    if (!isobj4RowSpanDisabled)
                    {
                        this.PendingFunctionBindings["M_GetRowSpan_4125562139"] = new InvokeFunctionDelegate(this.Invoke_M_GetRowSpan_4125562139); 
                    }
                }
            }
            private void Update_ViewModel_CustomerDetails(global::Inventory.ViewModels.CustomerDetailsViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Inventory_Views_CustomersDetails_ViewModel(this.obj12, obj, null);
                    }
                }
            }
            ...
            private void Update_ViewModel_CustomerDetails_IsDataUnavailable_Cast_IsDataUnavailable_To_Visibility(global::Windows.UI.Xaml.Visibility obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Customers\CustomersView.xaml line 70
            ...
            private void Update_ViewModel_AddressList(global::Inventory.ViewModels.CustomerAddressListViewModel obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\Customers\CustomersView.xaml line 61
                    if (!isobj10ViewModelDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Views_CustomerAddressList_ViewModel(this.obj10, obj, null);
                    }
                }
            }
            private void Update_ViewModel_CommunicationList(global::Inventory.ViewModels.CommunicationListViewModel obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    if (!isobj11ViewModelDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Views_CommunicationList_ViewModel(this.obj11, obj, null);
                    }
                }
            }
            private void Update_ViewModel_IsMainView(global::System.Boolean obj, int phase)
            {
                ...
                {
                    // Views\Customers\CustomersView.xaml line 33
                    if (!isobj13IsButtonVisibleDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_Section_IsButtonVisible(this.obj13, obj);
                    }
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 13: // Views\Customers\CustomersView.xaml line 33
                {
                    global::Inventory.Controls.Section element13 = (global::Inventory.Controls.Section)(target);
                    ((global::Inventory.Controls.Section)element13).HeaderButtonClick += this.OpenInNewView;
                }
                break;
            default:
                break;
