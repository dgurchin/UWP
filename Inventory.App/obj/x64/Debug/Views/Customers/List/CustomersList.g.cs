...
namespace Inventory.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks"," 10.0.17.0")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class CustomersList_obj2_Bindings :
            ...
            ICustomersList_Bindings
        {
            ...
            private CustomersList_obj2_BindingsTracking bindingsTracking;

            public CustomersList_obj2_Bindings()
            {
                this.bindingsTracking = new CustomersList_obj2_BindingsTracking(this);
            }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 2: // Views\Customers\List\CustomersList.xaml line 25
                        this.obj2 = new global::System.WeakReference((global::Windows.UI.Xaml.Controls.Grid)target);
                        break;
                    case 3: // Views\Customers\List\CustomersList.xaml line 26
                        this.obj3 = (global::Windows.UI.Xaml.Controls.Grid)target;
                        break;
                    case 4: // Views\Customers\List\CustomersList.xaml line 35
                        this.obj4 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 5: // Views\Customers\List\CustomersList.xaml line 36
                        this.obj5 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 6: // Views\Customers\List\CustomersList.xaml line 33
            ...
            private void Update_IsEmpty(global::System.Boolean obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 26
            ...
            private void Update_Id(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\Customers\List\CustomersList.xaml line 35
            ...
            private void Update_FullName(global::System.String obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 36
            ...
            private void Update_ThumbnailSource(global::System.Object obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 33
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks"," 10.0.17.0")]
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            private class CustomersList_obj2_BindingsTracking
            {
                private global::System.WeakReference<CustomersList_obj2_Bindings> weakRefToBindingObj; 

                public CustomersList_obj2_BindingsTracking(CustomersList_obj2_Bindings obj)
                {
                    weakRefToBindingObj = new global::System.WeakReference<CustomersList_obj2_Bindings>(obj);
                }

                public CustomersList_obj2_Bindings TryGetBindingObject()
                {
                    CustomersList_obj2_Bindings bindingObject = null;
                ...
                {
                    CustomersList_obj2_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
            ...
            ICustomersList_Bindings
        {
            ...
            // Fields for each control that has bindings.
            private global::Inventory.Controls.DataList obj8;

            // Static fields for each binding's enabled/disabled state
            private static bool isobj8ItemsSourceDisabled = false;
            private static bool isobj8ItemSecondaryActionInvokedCommandDisabled = false;
            private static bool isobj8SelectedItemDisabled = false;
            private static bool isobj8IsMultipleSelectionDisabled = false;
            private static bool isobj8ItemsCountDisabled = false;
            private static bool isobj8NewCommandDisabled = false;
            private static bool isobj8RefreshCommandDisabled = false;
            private static bool isobj8QueryDisabled = false;
            private static bool isobj8QuerySubmittedCommandDisabled = false;
            private static bool isobj8StartSelectionCommandDisabled = false;
            private static bool isobj8CancelSelectionCommandDisabled = false;
            private static bool isobj8SelectItemsCommandDisabled = false;
            private static bool isobj8DeselectItemsCommandDisabled = false;
            private static bool isobj8SelectRangesCommandDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                {
                    isobj8ItemSecondaryActionInvokedCommandDisabled = true;
                }
                ...
                {
                    isobj8IsMultipleSelectionDisabled = true;
                }
                else if (lineNumber == 49 && columnNumber == 24)
                {
                    isobj8ItemsCountDisabled = true;
                }
                else if (lineNumber == 50 && columnNumber == 24)
                {
                    isobj8NewCommandDisabled = true;
                }
                else if (lineNumber == 51 && columnNumber == 24)
                {
                    isobj8RefreshCommandDisabled = true;
                }
                else if (lineNumber == 52 && columnNumber == 24)
                {
                    isobj8QueryDisabled = true;
                }
                else if (lineNumber == 53 && columnNumber == 24)
                {
                    isobj8QuerySubmittedCommandDisabled = true;
                }
                else if (lineNumber == 54 && columnNumber == 24)
                {
                    isobj8StartSelectionCommandDisabled = true;
                }
                else if (lineNumber == 55 && columnNumber == 24)
                {
                    isobj8CancelSelectionCommandDisabled = true;
                }
                else if (lineNumber == 56 && columnNumber == 24)
                {
                    isobj8SelectItemsCommandDisabled = true;
                }
                else if (lineNumber == 57 && columnNumber == 24)
                {
                    isobj8DeselectItemsCommandDisabled = true;
                }
                else if (lineNumber == 58 && columnNumber == 24)
                {
                    isobj8SelectRangesCommandDisabled = true;
                }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 8: // Views\Customers\List\CustomersList.xaml line 42
                        this.obj8 = (global::Inventory.Controls.DataList)target;
            ...
            private void Update_ViewModel_Items(global::System.Collections.Generic.IList<global::Inventory.Models.CustomerModel> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8ItemsSourceDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_ItemsSource(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_OpenInNewViewCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8ItemSecondaryActionInvokedCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_ItemSecondaryActionInvokedCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_SelectedItem(global::Inventory.Models.CustomerModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_SelectedItem(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_IsMultipleSelection(global::System.Boolean obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8IsMultipleSelectionDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_IsMultipleSelection(this.obj8, obj);
                    }
                }
            }
            private void Update_ViewModel_ItemsCount(global::System.Int32 obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8ItemsCountDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_ItemsCount(this.obj8, obj);
                    }
                }
            }
            private void Update_ViewModel_NewCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8NewCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_NewCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_RefreshCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8RefreshCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_RefreshCommand(this.obj8, obj, null);
                    }
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8QuerySubmittedCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_QuerySubmittedCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_Query(global::System.String obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8QueryDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_Query(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_StartSelectionCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8StartSelectionCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_StartSelectionCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_CancelSelectionCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8CancelSelectionCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_CancelSelectionCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_SelectItemsCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8SelectItemsCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_SelectItemsCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_DeselectItemsCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8DeselectItemsCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_DeselectItemsCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_SelectRangesCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // Views\Customers\List\CustomersList.xaml line 42
                    if (!isobj8SelectRangesCommandDisabled)
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_SelectRangesCommand(this.obj8, obj, null);
                    }
                }
            }
            private void Update_ViewModel_DeleteSelectionCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Inventory_Controls_DataList_DeleteCommand(this.obj8, obj, null);
                    }
                }
            }
            private void UpdateTwoWay_8_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.SelectedItem = (global::Inventory.Models.CustomerModel)this.obj8.SelectedItem;
                        }
                    }
                }
            }
            private void UpdateTwoWay_8_IsMultipleSelection()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.IsMultipleSelection = this.obj8.IsMultipleSelection;
                        }
                    }
                }
            }
            private void UpdateTwoWay_8_Query()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.Query = this.obj8.Query;
                        }
                    }
                }
            }
            ...
            private class CustomersList_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_8(global::Inventory.Controls.DataList sourceObject)
                {
                    ...
                    sourceObject.RegisterPropertyChangedCallback(global::Inventory.Controls.DataList.IsMultipleSelectionProperty, (sender, prop) =>
                    {
                        ...
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_8_IsMultipleSelection();
                        }
                    });
                    sourceObject.RegisterPropertyChangedCallback(global::Inventory.Controls.DataList.QueryProperty, (sender, prop) =>
                    {
                        ...
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_8_Query();
                        }
                    });
                }
            }
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            case 2: // Views\Customers\List\CustomersList.xaml line 25
                {                    
                    ...
                    CustomersList_obj2_Bindings bindings = new CustomersList_obj2_Bindings();
                    returnValue = bindings;
