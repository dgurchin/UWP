    ...
    public partial class StatusBar : UserControl {
        ...
        public void RefreshStatus(RegistrationState state) {
            ...
            if (state == RegistrationState.Ok) {
                StatusLed.Source = new BitmapImage(new Uri(this.BaseUri, "/VOIP/Assets/led_connected.png"));
                StatusText.Text = ResourceLoader.GetForCurrentView().GetString("Registered");
            } else if (state == RegistrationState.Progress) {
                StatusLed.Source = new BitmapImage(new Uri(this.BaseUri, "/VOIP/Assets/led_inprogress.png"));
                StatusText.Text = ResourceLoader.GetForCurrentView().GetString("RegistrationInProgress");
            } else if (state == RegistrationState.Failed) {
                StatusLed.Source = new BitmapImage(new Uri(this.BaseUri, "/VOIP/Assets/led_error.png"));
                ...
                StatusLed.Source = new BitmapImage(new Uri(this.BaseUri, "/VOIP/Assets/led_disconnected.png"));
