...
namespace Linphone.Model {
    class LinphoneManager{
        ...
        public static DateTimeOffset TimeLastStateChanged { get; set; }
        private Core _core;
        ...
        private void coreListenerInit() {
            ...
            //_coreListener.OnAuthenticationRequested = this.AuthInfoRequested;
        ...
        //    catch (Exception)
        //    {
        //        MessageDialog connectionWarning = new MessageDialog("Проблема с Интернет или не заполнены настройки");
        //    }
        ...
        public String GetDefaultConfigPath() {
            return Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "VOIP\\Assets", "linphonerc");
        }
        ...
        public String GetFactoryConfigPath() {
            return Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "VOIP\\Assets", "linphonerc-factory");
        }

        public String GetRootCaPath() {
            return Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "VOIP\\Assets", "rootca.pem");
        }
        ...
        public void InitLinphoneCore() {
            ...
            //Core.DefaultProxyConfig.ContactUriParameters = "";
        ...
        private void ConfigurePaths() {
            ...
            string assetsPath = packagePath + "\\VOIP\\Assets";
        ...
        public async void NewOutgoingCall(String sipAddress) {
            ...
            catch (Exception ex)
            {
                ...
                //LogException("Phone", "NewOutgoingCall", ex);
            }
        ...
        void CallStateChanged(Core lc, Call call, CallState state, string message) {
            ...
            double razn = (DateTimeOffset.Now - TimeLastStateChanged).TotalSeconds;
            if (razn<0.5)
            {
                return;
            }

            TimeLastStateChanged = DateTimeOffset.Now;
