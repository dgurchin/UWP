...
namespace Linphone {
    ...
    public class BaseModel : INotifyPropertyChanged, CallControllerListener {
        ...
        public void NewCallStarted(string callerNumber) {
            this.Page.Frame.Navigate(typeof(VOIP.Views.Chats), new Uri("/VOIP/Views/InCall.xaml?sip=" + Utils.ReplacePlusInUri(callerNumber), UriKind.RelativeOrAbsolute));
        }
        ...
        public void CallEnded(Call call) {
            ...
            if (this.Page.Frame.CanGoBack) {
                ...
                this.Page.Frame.Navigate(typeof(VOIP.Views.InCall), null);
