...
namespace Linphone.Model {
    ...
    public class SettingsManager {
        ...
        public static async void InstallConfigFile() {
            ...
            if (!fInfo.Exists) {
                try {
                    StorageFile file1 = await StorageFile.GetFileFromPathAsync(Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "VOIP\\Assets", "linphonerc"));
