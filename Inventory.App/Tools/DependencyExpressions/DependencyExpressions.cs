...
namespace Inventory
{
    public class DependencyExpressions
    {
        ...
        public void Initialize(INotifyPropertyChanging source)
        {
            source.PropertyChanged += OnPropertyChanged;
        }

        public void Uninitialize(INotifyPropertyChanging source)
        {
            source.PropertyChanged -= OnPropertyChanged;
        }
        ...
        {
            if (sender is INotifyPropertyChanging source)
            {
                UpdateDependencies(source, e.PropertyName);
            }
        }

        public void UpdateDependencies(INotifyPropertyChanging source, string propertyName)
        {
