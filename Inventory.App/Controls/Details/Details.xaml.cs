...
{
    public sealed partial class Details : UserControl, INotifyPropertyChanging
    {
        ...
        private static void ToolbarVisibilityChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var control = d as Details;
            DependencyExpressions.UpdateDependencies(control, nameof(ToolbarVisibility));
        }

        public static readonly DependencyProperty ToolbarVisibilityProperty = DependencyProperty.Register(nameof(ToolbarVisibility), typeof(Visibility), typeof(Details), new PropertyMetadata(Visibility.Visible, ToolbarVisibilityChanged));
        #endregion
