...
namespace Inventory.Controls
{
    public class FormTextBox : TextBox, IFormControl
    {
        ...
        private readonly Brush _normalHeaderBrush = Application.Current.Resources["SystemControlForegroundAccentBrush"] as SolidColorBrush;
        private readonly Brush _requiredHeaderBrush = new SolidColorBrush(Colors.Firebrick);
        ...
        public static readonly DependencyProperty IsRequiredProperty = DependencyProperty.Register(nameof(IsRequired), typeof(bool), typeof(FormTextBox), new PropertyMetadata(null));

        public Brush ControlHeaderForegound
        {
            get
            {
                if (IsRequired)
                {
                    return _requiredHeaderBrush;
                }
                return _normalHeaderBrush;
            }
        }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _headerContentPresenter = base.GetTemplateChild("HeaderContentPresenter") as ContentPresenter;
        ...
        private void UpdateVisualState()
        {
            if (_isInitialized)
            {
                _headerContentPresenter.Foreground = ControlHeaderForegound;
