...
namespace Inventory.Controls
{
    public sealed partial class ListToolbar : UserControl
    {
        ...
        public static readonly DependencyProperty NewLabelProperty = DependencyProperty.Register(nameof(NewLabel), typeof(string), typeof(ListToolbar), new PropertyMetadata("Новый"));
        #endregion
        ...
        public static readonly DependencyProperty CancelLabelProperty = DependencyProperty.Register(nameof(CancelLabel), typeof(string), typeof(ListToolbar), new PropertyMetadata("Отменить"));
        #endregion
            ...
            if (e.OriginalSource is AppBarButton button)
            {
                switch (button.Name)
                {
                    ...
                    case "buttonCancel":
                        ...
                        break;
                    case "buttonFilter":
                        RaiseButtonClick(ToolbarButton.Filter);
                        break;
                    case "buttonSelect":
