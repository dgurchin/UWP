...
{
    public sealed partial class DataList : UserControl, INotifyPropertyChanging
    {
        private bool ignoreSelectedItemValue = false;
        ...
        public static readonly DependencyProperty NewLabelProperty = DependencyProperty.Register(nameof(NewLabel), typeof(string), typeof(DataList), new PropertyMetadata("Добавить"));
        #endregion
        ...
        public static readonly DependencyProperty CancelLabelProperty = DependencyProperty.Register(nameof(CancelLabel), typeof(string), typeof(DataList), new PropertyMetadata("Отменить"));
        #endregion
        ...
        #region IsExtendedSelection*
        public bool IsExtendedSelection
        {
            get { return (bool)GetValue(IsExtendedSelectionProperty); }
            set { SetValue(IsExtendedSelectionProperty, value); }
        }

        private static void IsExtendedSelectionChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var control = d as DataList;
            DependencyExpressions.UpdateDependencies(control, nameof(IsExtendedSelection));
        }

        public static readonly DependencyProperty IsExtendedSelectionProperty = DependencyProperty.Register(nameof(IsExtendedSelection), typeof(bool), typeof(DataList), new PropertyMetadata(null, IsExtendedSelectionChanged));
        #endregion
        ...
        public static readonly DependencyProperty FilterCommandProperty = DependencyProperty.Register(nameof(FilterCommand), typeof(ICommand), typeof(DataList), new PropertyMetadata(null));
        #endregion
        ...
        public static readonly DependencyProperty ItemInvokedCommandProperty = DependencyProperty.Register(nameof(ItemInvokedCommand), typeof(ICommand), typeof(DataList), new PropertyMetadata(null));
        #endregion
        ...
        #region ItemBackgroundRequest
        public delegate Brush ItemBackgroundRequestDelegate(object item);

        public ItemBackgroundRequestDelegate ItemBackgroundRequest
        {
            get { return (ItemBackgroundRequestDelegate)GetValue(ItemBackgroundRequestProperty); }
            set { SetValue(ItemBackgroundRequestProperty, value); }
        }

        public static readonly DependencyProperty ItemBackgroundRequestProperty =
            DependencyProperty.Register(nameof(ItemBackgroundRequest), typeof(ItemBackgroundRequestDelegate), typeof(DataList), new PropertyMetadata(null));
        #endregion
        ...
        public ListViewSelectionMode SelectionMode
        {
            get
            {
                if (IsMultipleSelection && IsExtendedSelection)
                {
        ...
        public string DataUnavailableMessage => ItemsSource == null ? "Загружается..." : "Нет данных.";
                        ...
                        if (ItemsSource is ISelectionInfo selectionInfo)
                        {
                            if (selectionInfo.IsSelected(e.NewStartingIndex))
                            {
                                if (!ignoreSelectedItemValue)
                                {
                                    ...
                                    System.Diagnostics.Debug.WriteLine("Выбрано {0}", SelectedItem);
                                }
                            }
                        }
                    }
        ...
        private void OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (IsMultipleSelection)
            {
                ...
                if (e.AddedItems != null)
                {
                    ...
                    {
                        SelectItemsCommand?.TryExecute(listview.SelectedItems);
                    }
                    else
                    {
        ...
        private void OnToolbarClick(object sender, ToolbarButtonClickEventArgs e)
        {
            switch (e.ClickedButton)
            {
                ...
                case ToolbarButton.Delete:
                    ...
                    break;
                case ToolbarButton.Filter:
                    FilterCommand?.TryExecute();
                    break;
        ...
        private void Listview_PreviewKeyDown(object sender, Windows.UI.Xaml.Input.KeyRoutedEventArgs e)
        {
            if (keyDownCount > 0)
            {
                ignoreSelectedItemValue = true;
            }
            keyDownCount++;
        }
        ...
        {
            if (ItemBackgroundRequest != null)
            {
                args.ItemContainer.Background = ItemBackgroundRequest.Invoke(args.Item);
            }
        }
        ...
        private void On_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            if (!IsMultipleSelection)
            {
                ItemInvokedCommand?.TryExecute(listview.SelectedItem);
            }
        }
        #endregion
    }
