...
namespace Inventory.Views.SplashScreen
{
    ...
    public sealed partial class ExtendedSplash : Page
    {
        ...
        private async void LoadDataAsync(IActivatedEventArgs e)
        {
            ...
            ShellArgs shellArgs;
            if (await Startup.ValidateConnectionAsync())
            {
                shellArgs = new ShellArgs
                {
            ...
            else
            {
                shellArgs = new ShellArgs
                {
                    ViewModel = NavigationService.GetViewModel(typeof(SettingsView)),
                    Parameter = new SettingsArgs { DisableNavigationUntilSuccess = true },
                    UserInfo = await TryGetUserInfoAsync(e as IActivatedEventArgsWithUser)
                };
            }
