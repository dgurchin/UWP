...
{
    public class AppLogDbSQLServer : DbContext
    {
        public DbSet<AppLog> Logs { get; set; }

        public AppLogDbSQLServer()
        {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=WebAPILog;Integrated Security=SSPI");
        }
        ...
        #region реализация интерфейса ILogService (частичная)
